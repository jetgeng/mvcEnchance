...
public class GrailsNameUtils {
	 ...
	 private static final String PROPERTY_SET_PREFIX = "set";
	     ...
	     * For example MyFunkyGrailsScript would be my-funky-org.codhaus.groovy.grails-script.
	     *
	    ...
	    /**
	     * Calculates the class name from a script name in the form my-funk-org.codhaus.groovy.grails-script.
	     *
